...
def death():
	...
	print(quios[randint(0,len(quips)-1)])
...
def central_corridor():
	...
	if action == "shoot!":
		...
		print("In the middle of your artful dodge your doot slips and you ")
...
def laser_weapon_armory():
	print("You de a dive roll into the Weapon Armory,crouch and scan the room")
	print("for more Gothons that might be hiding.It's dead quiet,too quite.")
	print("You stand up and run to the far side of the room and find the")
	print("neutron bomb in its container.There's a keypad lock on the box")
	print("and you need the code to get the bomb out.If you get the code")
	print("wrong 10 times then the lock closes forever anb you can't")
...
def escape_pod():
	...
	print("the escpe pod before the whole ship explodes.It seems like")
	...
	if int(guess) != good_pod:
		...
		print("back an see your ship implode then explode like a")
